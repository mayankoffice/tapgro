  ...
  return (
    <div className="container mx-auto" id="Features">
      ...
      <h2 className="text-center font-bold text-4xl mt-4 tracking-tight font-sans lg:font-serif">
        All in One App for all your Everyday <span className='bg-yellow-400 rounded-2xl p-1' style={{color:"#3EB0FE"}}>Business Needs</span> and <span className='rounded-2xl p-1' style={{color:"#158D00", background:"#BDFF30"}}>Growth</span> <br /> where not only we provide you
      </h2>
